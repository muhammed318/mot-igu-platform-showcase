...
| Layer | Technologies & Services | Architectural Purpose |
| :--- | :--- | :--- |
| **Client / Frontend** | React 18, Vite, Tailwind CSS v3, React Router v6, Lucide Icons | Responsive SPA, Native Right-to-Left (RTL) localization, stateless JWT session state. |
| **Server / Backend** | Node.js, Express.js, Prisma ORM, JWT, Bcrypt.js, CORS | Modular RESTful API, authentication middlewares, salted cryptographic password hashing. |
| **Database** | Serverless PostgreSQL on **Neon.tech** | Auto-scaling relational database with auto-suspend connection pooling. |
| **Cloud & DevOps** | **Vercel** (Frontend CDN) + **Render.com** (Node Service) | Zero-cost continuous deployment (CI/CD), global SSL, and low-latency edge delivery. |
...
1. **Defense-in-Depth Authentication:** Passwords hashed with 10-round Salted Bcrypt; API requests guarded by JWT verification middleware.
2. **Fault-Tolerant Async Loading:** The frontend dashboard utilizes `Promise.allSettled` to guarantee seamless UI rendering even if specific datasets are empty.
3. **Environment Isolation:** Zero credentials leaked; all connection strings, secrets, and origins are injected via runtime environment variables.

---

## 👨‍💻 Author & Developer
**Muhammed Eid** — *Full-Stack Software Engineer*
- **GitHub:** [@muhammed318](https://github.com/muhammed318)
- **Live Production Application:** [https://egyptian-student-union.vercel.app](https://egyptian-student-union.vercel.app)
